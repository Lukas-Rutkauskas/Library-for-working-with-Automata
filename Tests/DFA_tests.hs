...
dfa1 :: DFA Char Int
dfa1 = Dfa [0,1,2,3] ['0','1'] 0 [3] delta
  where delta 0 '0' = 1
        delta 0 '1' = 0
        delta 1 '0' = 1
        delta 1 '1' = 2
...
test2 = TestCase (assertBool "101 should be rejected" (not $ dfaAccept dfa1 "101"))
test3 = TestCase (assertBool "011010 should be accepted" (dfaAccept dfa1 "011010"))

tests1 = TestList [TestLabel "test 010 - accept" test1, TestLabel "test 101 - reject" test2, TestLabel "test 011010 - accept" test3]
...
test6 = TestCase (assertBool "0000 should be accepted" (not $ dfaAccept dfa2 [0,0,0,0]))

tests2 = TestList [TestLabel "test 0101 - accept" test4, TestLabel "test 10011 - reject" test5, TestLabel "test 0000 - reject" test6]
